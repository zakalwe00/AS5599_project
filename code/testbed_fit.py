...
AGNLCLib.Fit(model,select_period='Aug22-Dec22')
AGNLCLib.ConvergencePlot(model,select_period='Aug22-Dec22')
AGNLCLib.ChainsPlot(model,select_period='Aug22-Dec22',select='delta')
AGNLCLib.CornerPlot(model,select_period='Aug22-Dec22',select='all')
AGNLCLib.FitPlot(model,'Aug22-Dec22')
AGNLCLib.Fit(model,select_period='Mar23-Jun23')
AGNLCLib.ConvergencePlot(model,select_period='Mar23-Jun23')
AGNLCLib.ChainsPlot(model,select_period='Mar23-Jun23',select='delta')
AGNLCLib.CornerPlot(model,select_period='Mar23-Jun23',select='all')
AGNLCLib.FitPlot(model,'Mar23-Jun23')
